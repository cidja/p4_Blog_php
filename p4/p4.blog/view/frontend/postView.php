<!--Dans cette vue, on affiche le billet (récupéré avec $post ) et les commentaires (récupérés dans$comments ) !-->
        ...
        ?>
            ...
            <a href="index.php?action=signalComment&amp;id=<?= $comment["id"]?>" id="signallink">Signaler le commentaire</a><!--Utiliser pour renvoyer sur une page pour valider la signalisation de commentaire !-->
        <?php
